...
namespace ShopBridgeAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer(Configuration["DatabaseConnection"]).UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking), ServiceLifetime.Scoped);
            services.AddScoped<IUnitOfWork, UnitOfWork>();
            services.AddScoped<IShopBridgeService,ShopBridgeServices>();
            services.AddScoped<IShopBridgeRepository, ShopBridgeRepo>();
